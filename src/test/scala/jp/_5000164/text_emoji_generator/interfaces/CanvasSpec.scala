...
class CanvasSpec extends FreeSpec {
  ...
  "左寄せで 3 行の印字位置を計算" in {
    val text = """さ
                 ...
                 |行""".stripMargin
    assert(Canvas.calculatePrintChar(text, Left) === Seq(
      PrintChar("さ", 21.333333333333332, 21.333333333333332, 42.666666666666664, 42.666666666666664),
      PrintChar("ん", 21.333333333333332, 64.0, 42.666666666666664, 42.666666666666664),
      PrintChar("行", 21.333333333333332, 106.66666666666667, 42.666666666666664, 42.666666666666664)))
  }
